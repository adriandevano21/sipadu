...
class Spss_regsosek extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('spss_regsosek_model');
    ...
    public function tambah() // fungsi ini digunakan untuk menambahkan aktivitas
    {
        ...
        $this->form_validation->set_rules('nama_tetangga', 'nama_tetangga', 'required');
        ...
        if ($this->form_validation->run()) {
            ...
            $nama_tetangga = $this->input->post('nama_tetangga');
            $no_hp = $this->input->post('no_hp');


            $params = array(
                'username'              => $username,
                'nama_tetangga'         => $nama_tetangga,
                'no_hp'                 => $no_hp,
                'tanggal'               => $tanggal

            );

            $this->master_model->insert("spss_regsosek", $params);

            $this->session->set_flashdata('sukses', "Data yg anda masukan berhasil");

            redirect('spss_regsosek/tambah');
        } else {
