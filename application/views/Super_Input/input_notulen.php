...
<div class="card">
	...
	<div class="card-body">
		...
		<form class="form-validate-jquery" method="post" action="" enctype="multipart/form-data">
					...
					<div class="table-responsive table-scrollable">
						<table class="table">
							...
							<?php foreach ($peserta_rapat as $key => $value) { ?>
								<tr>
									<td>
										<input type="checkbox" class="form-check-input-styled-success" <?php echo ($value["status"] == "1") ? "checked" : ""; ?> data-fouc name="hadir[]" value=<?= $value["id"] ?>>
									</td>
					...
					<div class="table-responsive table-scrollable">
						<table width="100%" class="table">
							...
							<?php foreach ($peserta_rapat_eksternal as $key => $value) { ?>
								<tr>
									<td>
										<input type="checkbox" class="form-check-input-styled-success" data-fouc name="hadir_eksternal[]" value=<?= $value["id"]; ?>>
									</td>
									<td>
			...
			<div class="mb-3">
				<textarea name="notulen"  rows="4" cols="4" ><?= $detail_rapat["notulen"] ?></textarea>
			</div>
