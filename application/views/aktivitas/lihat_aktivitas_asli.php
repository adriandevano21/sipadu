    ...
    <table class="table datatable-button-html5-basic">
        ...
        <thead>
            <tr>
                ...
                <th class="text-center">WFH/WFO</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php
                        if ($value['status_kerja'] == "WFO") { ?>
                            <span class="badge badge-flat border-primary text-primary-600"><?php echo $value['status_kerja']; ?></span>
                        <?php
                        } else if ($value['status_kerja'] == "WFH") { ?>
                            <span class="badge badge-flat border-success text-success-600"><?php echo $value['status_kerja']; ?></span>
                        <?php
                        } ?>
                    </td>
