            ...
            <fieldset class="mb-3">
                ...
                <div id="penugasan">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select multiple="multiple" data-placeholder="   Pegawai yang ditugaskan" class="form-control form-control-sm select" data-container-css-class="select-sm" data-fouc name="username_peserta" id="username_peserta">
                            <option></option>
                            <?php foreach ($pegawai
                                as $key => $value) { ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah Anda yakin ingin membuat kegiatan ini?
      </div>
