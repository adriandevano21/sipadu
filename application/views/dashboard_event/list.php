...
<div class="card">
    <div class="card-header header-elements-inline">
        ...
        <a href="<?= base_url(); ?>/dashboard_event/pegawai">
            <button type="button" class="btn btn-outline-success"> Event Pegawai</button>
        </a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="<?= base_url(); ?>dashboard_event/lihat/<?= $value['id_rapat'] ?>">
    ...
    $(document).ready(function() {
        ...
        var events = [
            <?php foreach ($rapat as $rapat) : ?> {
                    ...
                    url: '<?php echo base_url('dashboard_event/lihat/') . $rapat['id_rapat'] ?>'
                },
            <?php endforeach; ?>
        ];
