        ...
        <form class="form-validate-jquery" method="post" action="">
            <fieldset class="mb-3">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control select" name="id_jenis_kegiatan" id="jenis" required>
                            <option value="">Pilih Jenis Kegiatan</option>
                            <option value="1">Rapat Di Dalam Kantor</option>
                            <option value="2">Rapat Di Luar Kantor</option>
                            <option value="3">Pelatihan</option>
                            <option value="4">Narasumber</option>
                            <option value="5">Perjadin</option>
                            <option value="6">Lainnya</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3">Tim</label>
                    <div class="col-lg-9">
                        <select class="form-control select" name="id_tim" required>
                            <option value="">Pilih Tim</option>
                            <option value="1">Umum </option>
                            <option value="2">Statistik Sosial</option>
                            <option value="3">Statistik Ekonomi</option>
                            <option value="4">Sensus</option>
                            <option value="5">Pengolahan dan TI</option>
                            <option value="6">Nerwilis</option>
                            <option value="7">Diseminasi, Publikasi dan PSS</option>
                            <option value="8">Transformasi Organisasi</option>
                            <option value="9">Penyiapan Materi Pimpinan</option>
                ...
                <div class="form-group row" id="pimpinan_rapat">
                    ...
                    <div class="col-lg-9">
                        <select data-placeholder="yang bertanda tangan di surat undangan" class="form-control select-minimum" data-fouc name="username_pengundang">
                            <option></option>
