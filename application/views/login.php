...
<head>
    ...
    <title>SIPADU BPS Prov Aceh</title>
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content d-flex justify-content-center align-items-center">
                ...
                <!-- Login card -->
                <form class="login-form" method="post" action="login_biasa/dologin">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <img src="<?= base_url(); ?>/global_assets/images/logo_bps2.jpg" alt="">
                            ...
                            <div class="form-group text-center text-muted content-divider">
                                <!--<span class="px-2">or sign in SSO</span>-->
                            </div>

                            

                            <div class="form-group">
                                <a href="<?= base_url(); ?>login/sso" class="btn btn-light btn-block">SSO Pegawai</a>
                            </div>
