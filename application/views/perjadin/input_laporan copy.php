        ...
        <form method="post" action="<?= base_url(); ?>/perjadin/input_laporan/<?= $detail_perjadin['id_perjadin']; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    ...
                    <br>
                    <textarea name="permasalahan" id="editor-full1" class="editor-full" rows="2" cols="2" required><?= $detail_perjadin['uraian_kegiatan']; ?></textarea>
                </div>
                <!--<div class="col-sm-6">-->
                <!--    <label>-->
                <!--        <h2>Solusi</h2>-->
                <!--    </label>-->
                <!--    <br>-->
                <!--    <textarea id="editor-full2" class="editor-full" rows="2" cols="2" name="solusi" required><?= $detail_perjadin['solusi']; ?></textarea>-->
                <!--</div>-->
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label>
                        <h2>Dukungan Provinsi</h2>
                    </label>
                    <br>
                    <textarea id="editor-full3" class="editor-full" rows="2" cols="2" name="dukungan" required><?= $detail_perjadin['dukungan']; ?></textarea>
                </div>
                <div class="col-sm-6">
                    <label>
