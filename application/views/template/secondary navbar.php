<style>
    ...
    .navbar-light .show>.navbar-nav-link {
        color: #fff !important; 
        /*background-color: rgba(12, 140, 68, 255) !important; border-teal-400*/ 
...
<div class="navbar navbar-expand-md navbar-light navbar-sticky">
    ...
    <div class="navbar-collapse collapse" id="navbar-navigation">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="<?= base_url(); ?>aktivitas/tambah" class="dropdown-item"><i class="icon-file-plus"></i>Tambah
                        Kegiatan</a>
                        <a href="<?= base_url(); ?>aktivitas/getAktivitasByDateAndUsername" class="dropdown-item"><i class="icon-file-plus"></i>Liat
                        Kegiatan Tim</a>
                        <a href="<?= base_url(); ?>aktivitas/perorang" class="dropdown-item"><i class="icon-calendar"></i>Kegiatan Perorangan
                        </a>
                        <a href="<?= base_url(); ?>detail_kegiatan/" class="dropdown-item"><i class="icon-file-plus"></i>Dokumentasi Kegiatan
                        </a>
                        <a href="<?= base_url(); ?>projek/list" class="dropdown-item"><i class="icon-copy"></i>Projek
                        </a>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle<?= (strpos(uri_string(), 'event') !== false) ? '  active' : ''; ?>" data-toggle="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="<?= base_url(); ?>event/list" class="dropdown-item"><i class="icon-table"></i>List Event</a>
                    <a href="<?= base_url(); ?>event/tambah" class="dropdown-item"><i class="icon-plus3"></i>Tambah Event</a>
                    <a href="<?= base_url(); ?>agenda" class="dropdown-item"><i class="icon-table"></i>Agenda</a>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle<?= (strpos(uri_string(), 'surat') !== false) ? '  active' : ''; ?>" data-toggle="dropdown">
                    <i class="icon-mail5 mr-2"></i>
                    Surat
                </a>
                <div class="dropdown-menu">
                    <a href="<?= base_url(); ?>surat" class="dropdown-item"><i class="icon-table"></i>No Surat</a>
                    <a href="<?= base_url(); ?>surat_masuk/list" class="dropdown-item"><i class="icon-mail5"></i>Surat Masuk</a>
                </div>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a href="<?= base_url(); ?>projects" class="navbar-nav-link<?= (strpos(uri_string(), 'tasks') !== false) ? '  active' : ''; ?>">
                    <i class="icon-puzzle3 mr-2"></i>
                    Project
                </a>
            </li>
            <!--<li class="nav-item ">-->
            ...
            <!--</li>-->
            <li class="nav-item">
                <a href="<?= base_url(); ?>pendapatan" class="navbar-nav-link<?= (strpos(uri_string(), 'pendapatan') !== false) ? '  active' : ''; ?>">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="https://sites.google.com/view/abah-2023/home" target="_blank" class="dropdown-item"><i class="icon-file-text2"></i>ABAH</a>
                    <a href="https://sites.google.com/view/sikatacehlogin/beranda" target="_blank" class="dropdown-item"><i class="icon-folder-open"></i>SIKAT</a>
                    <a href="https://sites.google.com/view/keuanganlink" target="_blank" class="dropdown-item"><i class="icon-cash4"></i>Informasi Keuangan</a>
                    <a href="https://laci.bpsaceh.cloud/" target="_blank" class="dropdown-item"><i class="icon-file-text2"></i>LACI</a>
                    <a href="https://bupesta.web.bps.go.id/" target="_blank" class="dropdown-item"><i class="icon-file-text2"></i>Bupesta</a>
                    <a href="https://r374bps.wixsite.com/pikram" target="_blank" class="dropdown-item"><i class="icon-file-text2"></i>PIKRAM</a>
                    <a href="https://sites.google.com/view/pbj1100" target="_blank" class="dropdown-item"><i class="icon-file-text2"></i>PBJ</a>
                    <a href="https://qna.bpsaceh.com/" target="_blank" class="dropdown-item"><i class="icon-box"></i>KOTAK</a>
